  ...
  useEffect(() => {
    if (isGoogleMapsLoaded && mapRef.current && !map) {
      ...
      if (mapId && mapId.trim() !== "") {
        ...
        console.log("🗺️ GoogleMapsNavigation using Map ID (styles controlled via cloud console):", mapId);
      } else {
        mapConfig.styles = [
          {
            featureType: "poi",
        ...
        console.log("🗺️ GoogleMapsNavigation using custom styles (no Map ID)");
      }
